...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s rubycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rubycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rubycoin transaction") + "\n" +
              "  rubycoin-tx [options] -create [commands]   " + _("Create hex-encoded rubycoin transaction") + "\n" +
              "\n";
