...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/rubycoin-project/rubycoin>";
    const std::string URL_WEBSITE = "<https://rubycoin.org>";
