...
const char * const BITCOIN_CONF_FILENAME = "rubycoin.conf";
const char * const BITCOIN_PID_FILENAME = "rubycoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Rubycoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Rubycoin";
#else
    // Unix
    return pathRet / ".rubycoin";
#endif
#endif
}
